...
const DEFAULT_TEAMS = [
  { id: 'team1', name: 'Echipa 1', score: 0 },
  { id: 'team2', name: 'Echipa 2', score: 0 },
  { id: 'team3', name: 'Echipa 3', score: 0 },
...
const DEFAULT_QUESTIONS = [
  ...
  { id: 'alg_3', category: 'Algorithms', points: 300, question: 'What is the worst-case time complexity of QuickSort?', answer: 'O(n²) – occurs when pivot is always the smallest or largest element', isPracticalTask: false, used: false },
  { id: 'alg_4', category: 'Algorithms', points: 400, question: 'Implement a function to check if a string is a palindrome', answer: 'str === str.split("").reverse().join("")', isPracticalTask: true, used: false },
  ...
  { id: 'db_2', category: 'Databases', points: 200, question: 'What is the difference between SQL and NoSQL databases?', answer: 'SQL databases are relational with fixed schema (tables); NoSQL are non-relational with flexible schema (documents, key-value, graphs, etc.)', isPracticalTask: false, used: false },
  ...
  { id: 'db_4', category: 'Databases', points: 400, question: 'Write a SQL query to find all users with score greater than 100, ordered by score descending', answer: 'SELECT * FROM users WHERE score > 100 ORDER BY score DESC', isPracticalTask: true, used: false },
  ...
  // DevOps
  { id: 'devops_1', category: 'DevOps', points: 100, question: 'What does CI/CD stand for?', answer: 'Continuous Integration / Continuous Delivery (or Deployment)', isPracticalTask: false, used: false },
